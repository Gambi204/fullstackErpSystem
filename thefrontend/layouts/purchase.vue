                ...
                <div class="dark:bg-gray-800 text-white">
                    <div class="container mx-auto flex justify-between items-center p-4">
                        <div class="flex items-center">
                            <nuxt-link to="/purchase" class="flex items-center space-x-3 rtl:space-x-reverse">
                        ...
                        <span class="text-sm mr-1">Company: JikoTrack</span>
                        <div class="relative">
                            ...
                            <div id="dropdownMenu"
                                ...
                                <div class="p-4">
                                    ...
                                    <p class="text-sm text-zinc-600">name@flowbite.com</p>
                                </div>
                                ...
                                <div class="border-t border-zinc-200"></div>
                                <a href="#" class="block px-4 py-2 hover:bg-zinc-100">Sign out</a>
                            </div>
                        </div>
                    </div>
                </div>
