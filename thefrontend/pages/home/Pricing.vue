        ...
        <div
            ...
            <ul role="list" class="space-y-5 my-7">
                <li class="flex items-center">
                    ...
                    <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">1 team
                        member</span>
                </li>
                <li class="flex">
                    <svg class="flex-shrink-0 w-4 h-4 text-blue-700 dark:text-blue-500" aria-hidden="true"
                    ...
                    <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">10GB Cloud
                        storage</span>
                </li>
                <li class="flex">
                    <svg class="flex-shrink-0 w-4 h-4 text-blue-700 dark:text-blue-500" aria-hidden="true"
                    ...
                    <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">Email
                        support</span>
                </li>
